...
public class EvtActivFeatSelTestPanel implements ItemListener {
	...
	public EvtActivFeatSelTestPanel(JCheckBox chckbxActivate, JButton btnResults, JComboBox<String> comboBoxAlgorithm,
			JLabel lblAlgorithm, JTextField maxFeatTextField, JLabel lblMaxNumberOf) {
	...
	private void activateFeatSel(boolean activate) {
		...
		maxFeatTextField.setText(Integer.toString(system.Parameters.testPanelMaxFeat));
